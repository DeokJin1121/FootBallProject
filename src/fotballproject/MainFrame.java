...
//-------------------------------------------------------------------------------------------------      
      ...
      JLabel lblText1 = new JLabel("<html><body><center>MANCHESTER CITY<br>PLAYER MANAGEMENT<br>PROGRAM</center></body></html>");
   ...
   public void run() {
	   ...
	   int n = 0;
		while(true) {
			int x = getX() + rnd.nextInt() % 90 - 200;		//나머지를 구하기 때문에 rnd가 얼마든 -4 ~ 4 의 값이 나옴
			int y = getY() + rnd.nextInt() % 7 +110;
